			<div class="row">
                ...
                <div class="col-lg-6">
                    <a href="<?= site_url(); ?>suratmasuk/pdf" class="btn btn-primary float-right" title="Cetak"><i class="ion-printer"></i></a>
                ...
                <tbody>
                    <?php
                        foreach ($datasurat as $surat) { ?>
							...
							<input type="text" style="display:none" id="tanggal_terima-<?= $surat['no_agenda'] ?>" value="<?= $surat['tanggal_terima'] ?>">
                            ...
                            <tr>
                                ...
                                <td>
									...
									<div class="dropdown">
										<a href="#" class="btn btn-primary btn-sm" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Cetak"><i class="ion-printer"></i></a>
		  								<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
											<a class="dropdown-item" href="<?= site_url(); ?>sekretaris/tandaTerima/<?= $surat['no_agenda'] ?>">Bukti terima Surat</a>
											<a class="dropdown-item" href="<?= site_url(); ?>sekretaris/detailSuratPdf/<?= $surat['no_agenda'] ?>">Detail Surat</a>
		  								</div>
									</div>
                                </td>
                            </tr>
                ...
                <form action="<?= site_url(); ?>suratmasuk/tambah" method="post">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="tanggal_terima" class="form-control form_datetime" readonly="">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
	...
	<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= site_url(); ?>suratmasuk/edit" method="post">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-4">
                                <label>No Agenda</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="tanggal_terima" id="tanggal_terima" class="form-control form_datetime" readonly="">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$(".edit").click(function(){
				...
				$("#tanggal_terima").val($("#tanggal_terima-"+id).val());
