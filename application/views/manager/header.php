        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                <li class="<?php if($title == "Dashboard") { echo "active"; } ?>">
                    <a href="<?= site_url(); ?>manager/"><i class="ion-home"></i> Dashboard</a>
                </li>
                <li class="<?php if($title == "Surat Masuk") { echo "active"; } ?>">
                    <a href="<?= site_url(); ?>manager/suratMasuk"><i class="ion-archive"></i> Surat Masuk</a>
                </li>
                <li class="<?php if($title == "Surat Keluar") { echo "active"; } ?>">
                    <a href="<?= site_url(); ?>manager/suratKeluar"><i class="ion-paper-airplane"></i> Surat Keluar</a>
                </li>
                <li class="<?php if($title == "Disposisi") { echo "active"; } ?>">
                    <a href="<?= site_url(); ?>manager/disposisi"><i class="ion-forward"></i> Disposisi</a>
                </li>
            </ul>
            ...
            <nav class="navbar navbar-default">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <button type="button" data-target="#notif" data-toggle="modal" class="btn btn-info navbar-btn" style="background-color: #ed7506">
                            <i class="ion-android-notifications-none"></i> <?= $jumlah; ?>
                        </button>
                    </div>
